...
final class ToolRegistry {
    ...
    private let cacheExcludedTools: Set<String> = ["execute_action", "get_screenshot", "get_view_snapshots", "edit_project_file", "highlight_view", "modify_view", "ui_interact", "hot_reload"]
